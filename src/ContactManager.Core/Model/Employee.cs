...
namespace ContactManager.Core.Model
{
    public class Employee : Person
    {
        ...
        public DateTime StartDate { get => _startDate; set => _startDate = value == default ? throw new ArgumentException("Das StartDatum muss einen Wert enthalten.") : value; }
        public virtual DateTime EndDate { get => _endDate; set => _endDate = value; }
        public int Employment { get => _empolyment; set => _empolyment = value % 20 != 0 || value > 100 || value <= 0 ? throw new ArgumentException("Der Beschäftigungsgrad ist nicht richtig") : value; }
        ...
        public virtual int CadreLevel { get => _cadreLevel; set => _cadreLevel = value < 0 || value > 5 ? throw new ArgumentException("Der CadreLevel ist nicht richtig") : value; }
