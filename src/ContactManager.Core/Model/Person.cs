...
namespace ContactManager.Core.Model
{
    ...
    public abstract class Person
    {
        ...
        public string PhoneNumberPrivat { get => _phoneNumberPrivat; set => _phoneNumberPrivat = !Phone.IsValid(value) ? throw new ArgumentException("Die Privatnummer ist nicht gültig.", nameof(value)) : Phone.Normalize(value); }
